# hibernate-kotlin-reactive-panache Project
...
You can then execute your native executable with: `./target/hibernate-kotlin-reactive-panache-1.0.0-SNAPSHOT-runner`
